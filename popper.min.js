...
!(function (e, t) {
    ...
    function E(e, n) {
        ...
        } else o(n) ? (((e = i(n)).top += n.clientTop), (e.left += n.clientLeft), (e.bottom = e.top + n.clientHeight), (e.right = e.left + n.clientWidth), (e.width = n.clientWidth), (e.height = n.clientHeight), (e.x = e.left), (e.y = e.top)) : ((u = f(e)), (e = f(u)), (s = a(u)), (n = null == (r = u.ownerDocument) ? void 0 : r.body), (r = z(e.scrollWidth, e.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0)), (l = z(e.scrollHeight, e.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0)), (u = -s.scrollLeft + p(u)), (s = -s.scrollTop), "rtl" === c(n || e).direction && (u += z(e.clientWidth, n ? n.clientWidth : 0) - r), (e = j({ width: r, height: l, x: u, y: s })));
        return e;
    }
    function D(e, t, r) {
        return (
    ...
    function T(e) {
        ...
        if (!0 === (e = e.roundOffsets)) {
            ...
            e = { x: X(X(s.x * d) / d) || 0, y: X(X(e * d) / d) || 0 };
        ...
        return (
            (o = Object.assign({ position: p }, u && Q)),
            l
                ? Object.assign(
                      {},
                      o,
